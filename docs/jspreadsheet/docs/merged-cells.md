  ...
  return (
    <>
      ...
      <input
        ...
        onclick="spreadsheet.current[0].setMerge('A3', 2, 3);"
      />
      <input
        type="text"
        value="removeMerge('A3')"
        onclick="spreadsheet.current[0].removeMerge('A3');"
      />
      <input
        type="text"
      ...
      <input
        ...
        onclick="spreadsheet.current[0].destroyMerge();"
      />
    </>
  );
}
