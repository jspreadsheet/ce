      ...
      worksheets: [
        {
          data: [
            ...
            ["Expo Dry-erase Markers Wide", 4, 3.0, 0.1, "=B3*C3*(1-D3)"],
            ["Index Cards Unlined", 3, 6.0, 0.03, "=B4*C4*(1-D4)"],
            ["Tissues", 10, 1.9, 0.01, "=B5*C5*(1-D5)"],
            ["Ziploc Sandwich-size Bags", 5, 1.0, 0.01, "=B6*C6*(1-D6)"],
            ["Thin Markers Crayola only", 2, 3.0, 0.02, "=B7*C7*(1-D7)"],
            ["Highlighter", 4, 1.2, 0.01, "=B8*C8*(1-D8)"],
            [
              "Total",
              "=SUM(B1:B8)",
              "=ROUND(SUM(C1:C8), 2)",
