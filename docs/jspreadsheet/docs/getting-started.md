...
<link
  rel="stylesheet"
  href="https://cdn.jsdelivr.net/npm/jspreadsheet-ce@5.0.0-beta.3/dist/jspreadsheet.min.css"
  type="text/css"
/>
...
<html>
  ...
  <link
    rel="canonical"
    href="https://bossanova.uk/jspreadsheet/docs/getting-started"
  />
  <link
    rel="stylesheet"
    href="https://fonts.googleapis.com/css?family=Material+Icons"
  ...
  <p>
    <input type="button" value="Destroy" id="btn1" />
    <input type="button" value="Create" id="btn2" />
  </p>
