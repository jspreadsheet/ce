...
<html>
  ...
  <br />
  <button type="button" id="setComments" style="width:220px;">
    Set A1 comments
  </button>
  <button type="button" id="getComments" style="width:220px;">
    Get A1 comments
  </button>
  <button type="button" id="resetComments" style="width:220px;">
    Reset A1 comments
  </button>
</html>
```
